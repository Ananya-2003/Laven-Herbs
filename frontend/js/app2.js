...
const Cart = {
  ...
  add(id, qty=1){
    ...
    this.save();
    showToast(`${p.name.split(" ").slice(0,4).join(" ")}… added to bag`);
    flyToCart();
    openCart();
  },
  updateQty(id, qty){
  ...
  render(){
    ...
    if(this.items.length === 0){
      wrap.innerHTML = `<div class="cart-empty">${ICONS.bag}<p>Your bag is waiting to be filled with botanicals.</p></div>`;
...
$("#searchInput").addEventListener("input", e => {
  ...
  `).join("") : `<div class="search-empty">No botanicals found for “${q}”.</div>`;
});
  ...
  <article class="product-card reveal" data-id="${p.id}">
    ...
    <div data-open-pdp="${p.id}">
      <div class="product-info">
        ...
        ${isComingSoon ? "" : `<span class="product-price"><span class="product-mrp">${fmt(p.mrp)}</span>${fmt(p.price)}</span>`}
      </div>
...
function openPDP(id){
  ...
  overlay.innerHTML = `
    <div class="pdp-modal">
      ...
      <div class="pdp-body">
        ...
        ${isComingSoon ? `<div class="pdp-price pdp-price-soon">Price revealed at launch</div>` : `<div class="pdp-price"><span class="pdp-mrp">${fmt(p.mrp)}</span>${fmt(p.price)}</div>`}
  ...
  $("#pdpAddBtn").addEventListener("click", () => {
    if(!p.inStock){ showToast("We'll email you when it's back!"); return; }
...
function renderHome(){
  ...
  <section class="section container">
    <div class="split reveal">
      <div class="split-media"><img src="assets/logo-icon.png" alt="Laven Herbs" class="big-sprig-img"></div>
      <div class="split-copy">
        <span class="eyebrow">Begin Your Ritual</span>
        <h2>Discover Your Ritual</h2>
        <p>Every skin is unique. Every ritual should be too. Explore our full collection and find the botanicals that speak to yours.</p>
  ...
  <section class="section container">
    <div class="cta-band reveal">
      ...
      <p>Explore our full collection of botanical skincare, crafted with intention for every skin type.</p>
      <a href="#/shop" data-link class="btn btn-outline-light">Shop the Collection</a>
    </div>
  </section>
  `;
}
...
function renderShop(params){
  ...
  <section class="page-hero">
    <div class="container">
      ...
      <p>Every formula crafted with intention. Every ingredient chosen with care.</p>
    </div>
  </section>
...
function wireShopPage(params){
  ...
  function draw(){
    ...
    grid.innerHTML = list.map(productCard).join("") || `<p style="grid-column:1/-1;color:var(--ink-faint)">No products in this category yet.</p>`;
...
function renderAbout(){
  ...
  <section class="story-hero">
    <div class="container">
      ...
      <h1>Rooted in Nature.<br>Refined by Purpose.</h1>
    </div>
  </section>
  ...
  <section class="container">
    <div class="sprig-divider"><img src="assets/logo-icon.png" alt=""></div>
  </section>

  <section class="container">
    ${FOUNDERS.map(founderBlock).join('<div class="founder-divider"></div>')}
  </section>
...
function renderIngredients(){
  ...
  <section class="page-hero">
    <div class="container">
      ...
      <h1>Ingredients &amp; Benefits</h1>
      <p>Every botanical we use, explained plainly — what it does and why it's in the bottle.</p>
    </div>
  </section>
  <section class="container" style="padding:20px 0 40px">
    ${INGREDIENTS.map(ingredientRow).join("")}
  </section>
...
function renderContact(){
  ...
  <section class="contact-hero">
    <div class="container">
      ...
      <p>Questions about our formulas, ingredients, or your order? We're here.</p>
    </div>
  </section>
  <section class="section container">
    <div class="contact-grid">
      ...
      <div class="reveal">
        ...
        <div class="contact-info-block">
          <h5>Follow Along</h5>
          <div>Instagram — @lavenherbs</div>
          <div style="margin-top:6px">Pinterest — @lavenherbs</div>
        </div>
...
function renderCheckout(){
  if(Cart.items.length === 0){
    ...
    <section class="section container">
      <div class="empty-state reveal">
        ...
        <p>Add a few botanicals to begin checkout.</p>
  ...
  return `
  <section class="page-hero" style="padding:130px 0 50px">
    <div class="container">
...
function wireCheckoutPage(){
  ...
  $("#payNowBtn").addEventListener("click", async () => {
    ...
    try{
      ...
      console.error(err);
      showToast("Payment gateway unavailable. Please try again.", false);
      btn.disabled = false;
      btn.textContent = originalLabel;
    }
  });
...
function render404(){
  ...
  <section class="section container">
    <div class="empty-state reveal">
      ...
      <p>The page you're looking for doesn't exist — but our full collection is right here.</p>
...
$("#newsletterForm").addEventListener("submit", e => {
  e.preventDefault();
  showToast("You're on the list! Welcome to the ritual.");
  e.target.reset();
});
